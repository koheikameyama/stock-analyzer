    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-surface-50 via-blue-50/30 to-indigo-50/30 flex flex-col">
            ...
            <header className="bg-white/80 backdrop-blur-sm border-b border-surface-200 sticky top-0 z-50 shadow-sm">
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center gap-2">
                            ...
                            <button
                                ...
                                className="sm:hidden flex items-center justify-center w-9 h-9 rounded-lg hover:bg-surface-100 transition-colors"
                                aria-label="メニュー"
                            >
                                {isMobileMenuOpen ? (
                ...
                {/* モバイルメニュー展開 */}
                {isMobileMenuOpen && (
                    <div className="sm:hidden border-t border-surface-200 bg-white">
